...
from ultralytics.nn.modules.mobileone import *
from ultralytics.nn.modules.SE import SEAttention
from ultralytics.nn.modules.mobilenetv4 import MobileNetV4ConvLarge, MobileNetV4ConvSmall, MobileNetV4ConvMedium, MobileNetV4HybridMedium,MobileNetV4HybridLarge
...
class BaseModel(torch.nn.Module):
    ...
    def _profile_one_layer(self, m, x, dt):
        ...
        LOGGER.info(f"{dt[-1]:10.2f} {flops:10.2f}   {m.type}")
        if c:
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if verbose:
            LOGGER.info(f'{i:>3}{str(f):>20}{n_:>3}  {t:<45}{str(args):<30}')  # print
